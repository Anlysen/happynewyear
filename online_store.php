		...
		<section class="product-box">
			...
			<div class="row">
				<?foreach ($products as $product):?>
					<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3" data-id="<?=$product['id']?>">
						<div class="product">
							<div class="product-pic" style="background: url('<?=$product['image']?>') no-repeat;background-size:
										auto 100%; background-position: center"></div>
